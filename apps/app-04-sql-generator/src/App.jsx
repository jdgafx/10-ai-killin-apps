    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="bg-slate-900 border-b border-slate-700 px-4 py-2 flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 ml-4">
          ...
          <span className="text-green-400 font-mono text-sm">sql-generator v1.0.0</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        {/* Top Schema Sidebar */}
        <div className="lg:w-1/3 bg-slate-900 border-r border-slate-700 p-4 overflow-y-auto">
          <div className="mb-4">
            <div className="flex items-center gap-2 text-green-400 mb-2">
              <Database className="w-4 h-4" />
              <span className="font-mono text-sm uppercase tracking-wider">Database Schema</span>
            </div>
        ...
        <div className="flex-1 bg-black p-4 flex flex-col gap-4 overflow-y-auto">
          ...
          <div className="border border-green-400/30 bg-slate-900/50">
            <div className="bg-green-400/10 border-b border-green-400/30 px-3 py-1 flex items-center gap-2">
              <ChevronRight className="w-3 h-3 text-green-400" />
              <span className="font-mono text-xs text-green-400 uppercase">Natural Language Input</span>
            </div>
            <textarea
              value={question}
              ...
              placeholder="// Enter query in plain English..."
              className="w-full min-h-[120px] bg-transparent text-lime-300 font-mono text-sm px-3 py-2 focus:outline-none focus:ring-1 focus:ring-green-400 resize-none placeholder:text-slate-600"
              spellCheck={false}
            />
            <div className="border-t border-green-400/30 px-3 py-2 flex items-center justify-between bg-slate-900">
              ...
              <button
                ...
                className="px-4 py-1.5 bg-green-400 text-black font-mono text-xs uppercase tracking-wider hover:bg-lime-300 disabled:bg-slate-700 disabled:text-slate-500 disabled:cursor-not-allowed transition-colors"
              >
